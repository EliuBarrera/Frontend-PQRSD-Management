...
export const BarraLateral = (props:any) => {
    ...
    const sidebarHide:any = useSelector(SettingSelector.sidebar_show); // array
    ...
    useEffect(() => {
        Scrollbar.init(document.querySelector("#my-scrollbar") as any);
            ...
            >
                <div className="sidebar-header d-flex align-items-center justify-content-start">
                    <Link to="/dash" className="navbar-brand">
                        <img src={logo} alt="usatoto.png" height="40px"/>
                        <h4 className="logo-title">Gestión PQRSD</h4>
                    </Link>
                    <div
